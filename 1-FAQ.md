...
## Can Steel Battalion be Emulated and played on PC with the controller of my choosing?
...
You either need to buy a controller (expensive), map another controller (potentially expensive), or build a controller. Go to [my section on Custom Controller for Xbox](https://github.com/quizerno/DIY-Steel-Battalion-Controller-Guide/blob/main/3-Playing%20on%20Xbox%20Without%20An%20Original%20Controller.md).
...
## Can Line of Contact be Emulated and played on PC

As of the writing of this guide it is a work in progress.
